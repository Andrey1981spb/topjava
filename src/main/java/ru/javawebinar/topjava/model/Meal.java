...
import ru.javawebinar.topjava.util.LocalDatePersistenceConverter;
...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN, query = "SELECT m FROM Meal m WHERE m.dateTime BETWEEN :min AND :max ORDER BY m.dateTime DESC")
})
@Entity
@Table(name = "meals",
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BETWEEN = "User.getBetweenDate";
